...
| 2 | T001_RESUME_WORKTREE_ISOLATION_CORE | 在测试全绿后恢复并行隔离：git worktree + candidate_repo_root 约束 | high | IN_PROGRESS | 2026-02-03 23:17:09 | N/A |
...
| 2026-02-03 23:27:21 | T001_RESUME_WORKTREE_ISOLATION_CORE | implementers | implement | 候选 CANDIDATE_3：run-check.ps1 支持 -RepoRoot + 新测覆盖工作目录 | `make test`：1 failed（worktree.ps1 add/list/remove 失败） | 交给 verifier 复查 |
